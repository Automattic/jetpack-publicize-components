...
### Fixed
- Profile pictures now fail gracefully if they fail to load for any reason
...
[0.3.0-alpha]: https://github.com/Automattic/jetpack-publicize-components/compare/v0.2.2...v0.3.0-alpha
