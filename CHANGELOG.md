...
### Changed
- Changed upgrade nudge text to be more clear
- Social Previews: show custom Jetpack SEO Page Title if set for a post.
...
[0.10.0-alpha]: https://github.com/Automattic/jetpack-publicize-components/compare/v0.9.0...v0.10.0-alpha
