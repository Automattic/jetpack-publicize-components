...
### Fixed
- Fix UX for Social modal for resharing without user connection. [#44513]
...
[1.2.1-alpha]: https://github.com/Automattic/jetpack-publicize-components/compare/v1.2.0...v1.2.1-alpha
