...
## [0.67.0-alpha] - unreleased

This is an alpha version! The changes listed here are not final.

### Added
- Added tracking for the share status modal
...
[0.67.0-alpha]: https://github.com/Automattic/jetpack-publicize-components/compare/v0.66.1...v0.67.0-alpha
